...
<template>
  <main class="page settings-page">
    ...
    <section class="settings-group" aria-label="Install Old.dex"><div class="settings-group-heading"><p class="eyebrow settings-group-title">INSTALL</p></div><section class="settings-card"><div class="setting-row install-setting-row"><span><strong>Install Old.dex</strong><small>{{ installedApp ? 'Old.dex is running as an installed app on this device.' : installPrompt ? 'Install Old.dex as an app on this phone, tablet, or computer.' : 'Old.dex is installable. If the direct prompt is unavailable, use your browser menu and choose Install app or Add to Home Screen.' }}</small></span><button class="secondary-button settings-compact-action" type="button" :disabled="installedApp" @click="installOldDex">{{ installedApp ? 'Installed' : 'Install' }}</button></div></section></section>
    ...
    <section class="settings-group" aria-label="Support"><div class="settings-group-heading"><p class="eyebrow settings-group-title">SUPPORT</p></div><section class="settings-card support-settings-card"><div class="setting-row static-row support-copy-row"><span><strong>Support Old.dex</strong><small>Voluntary Support for Old.Dex – Not Affiliated with Games Workshop – Contributions Used Only for Domain and Hosting Costs</small></span></div><div class="support-button-row" aria-label="Old.dex support options"><a class="secondary-button support-action-button" href="https://buy.stripe.com/7sY9ATaA64LEf2Adzz3Nm02" target="_blank" rel="noopener noreferrer">One Time Gift</a><a class="secondary-button support-action-button" href="https://buy.stripe.com/4gM5kDbEa6TM9Ig7bb3Nm03" target="_blank" rel="noopener noreferrer">Recurring Gift</a></div></section></section>
    ...
    <section class="settings-group" aria-label="Data and content settings"><div class="settings-group-heading"><p class="eyebrow settings-group-title">DATA &amp; CONTENT</p></div><section class="settings-card">
      ...
      <details class="custom-data-panel cloud-sync-panel"><summary><span><strong>Cloud Sync</strong><small>Optionally connect Dropbox App Folder storage for explicit roster updates and uploads.</small></span><span class="value-chip">DROPBOX</span></summary><div class="custom-data-actions custom-data-stack">
        <div class="setting-row roster-cloud-detail"><span><strong>Dropbox App Folder</strong><small>Old.dex uses Dropbox App Folder access, so it can read and write only the folder Dropbox assigns to this app. Nothing is polled in the background. Only files ending in <code>_ODX.json</code> are considered during a manual sync.</small></span><div class="cloud-instructions-action"><a class="secondary-button settings-compact-action cloud-instructions-button" href="/downloads/OldDex-Cloud-Instructions.txt" download>Cloud Instructions (.txt)</a></div></div>
