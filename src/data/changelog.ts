...
export const changelogEntries: ChangelogEntry[] = [
  { version: '0.63', title: 'Old World Builder data-resolver rebuild and live source languages', notes: [
  ...
  { version: '0.52', title: 'Army-list rules, dynamic profiles, points, and expanded icons', notes: [
  ...
  { version: '0.50', title: 'Source architecture, loadouts, and option normalization', notes: [
  ...
  { version: '0.48', title: 'Approved icons and equipped-weapon presentation', notes: [
  ...
  { version: '0.46', title: 'Builder selection-state stabilization', notes: [
  ...
  { version: '0.41', title: 'Composition controls, profile icons, and Create List reliability', notes: [
  ...
  { version: '0.38', title: 'Weapon ownership, list management, and roster status', notes: [
  ...
  { version: '0.35', title: 'All-army roster validation and magic workflow', notes: [
  ...
  { version: '0.32', title: 'Data baseline, migration, and Builder integration', notes: [
  ...
  { version: '0.29', title: 'Round carry-forward and versioned battle state', notes: [
  ...
  { version: '0.26', title: 'Shooting, casting, combat, and full phase workflow', notes: [
  ...
  { version: '0.22', title: 'Imported armies and richer combat/profile UI', notes: [
  ...
  { version: '0.18', title: 'Scenario checks, import UI, and live round state', notes: [
  ...
  { version: '0.13', title: 'List import, scenarios, and persistent spell/challenge state', notes: [
  ...
  { version: '0.08', title: 'Battle-state presentation, defense, and round overview', notes: [
  ...
  { version: '0.04', title: 'Initial Old.dex battle tracker', notes: [
