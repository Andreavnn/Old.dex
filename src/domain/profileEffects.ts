...
export function incrementCharacteristic(value: string, amount: number) { const numeric = Number.parseInt(value, 10); return Number.isFinite(numeric) ? String(numeric + amount) : value }
