# Old.dex v0.031 — Canonical Profile Foundation Rebuild

**Version alignment:** current public alpha baseline is v0.30; this rebuild is v0.31. Older v0.5x identifiers are historical/internal patch artifacts and are not the active public changelog line.
...
```bash
python scripts/apply-v0031.py /path/to/Old.dex
```
